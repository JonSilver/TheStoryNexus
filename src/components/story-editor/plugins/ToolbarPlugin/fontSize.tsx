...
export default function FontSize({
    ...
    const updateFontSizeByInputValue = (inputValueNumber: number) => {
        ...
        if (inputValueNumber > MAX_ALLOWED_FONT_SIZE) updatedFontSize = MAX_ALLOWED_FONT_SIZE;
        else if (inputValueNumber < MIN_ALLOWED_FONT_SIZE) updatedFontSize = MIN_ALLOWED_FONT_SIZE;

...
export const MatchedEntriesPanel = ({
    ...
    <div className="p-4 border-t">
        <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-xs text-muted-foreground">Entries that match tags in your content</div>
        </div>
        ...
        <div className="space-y-4">
            ...
            <div>
                <div className="text-sm font-medium mb-2">
                    Chapter Matched Entries{" "}
                    {useMatchedChapter && <span className="text-xs text-green-500">(Included)</span>}
                </div>
            ...
            <div>
                <div className="text-sm font-medium mb-2">
                    Scene Beat Matched Entries{" "}
                    {useMatchedSceneBeat && <span className="text-xs text-green-500">(Included)</span>}
                </div>
                <div className="mb-4 border rounded-md p-3 bg-muted/10">
                    <EntryBadgeList
            ...
            {useCustomContext && (
                <div>
                    <div className="text-sm font-medium mb-2">
                        Custom Context Entries <span className="text-xs text-green-500">(Included)</span>
                    </div>
                    <div className="mb-4 border rounded-md p-3 bg-muted/10">
                        <EntryBadgeList entries={customContextEntries} showCategory emptyMessage="No items selected" />
                    </div>
                </div>
            )}
        </div>

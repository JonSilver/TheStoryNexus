...
import { SceneBeatHeader } from "./scene-beat/components/SceneBeatHeader";
...
import { useSceneBeatHandlers } from "./scene-beat/hooks/useSceneBeatHandlers";
import { useSceneBeatState } from "./scene-beat/hooks/useSceneBeatState";
...
function SceneBeatComponent({ nodeKey }: { nodeKey: NodeKey }): JSX.Element {
    ...
    // Wrap command change to also save

...
interface UseSceneBeatHandlersProps {
    ...
    deleteMutation: { mutate: (args: { id: string; chapterId: string }, opts?: { onError?: (err: Error) => void }) => void };

    // Generation functions
    generateWithConfig: (config: ReturnType<typeof createPromptConfig>, model: AllowedModel | undefined) => Promise<void>;

            ...
            <PopoverContent className="w-80">
                <div className="grid gap-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">Set the POV for this scene beat</p>
                    </div>
                    <div className="grid gap-2">
                        <Label htmlFor="povType">POV Type</Label>
                        <Select value={tempPovType} onValueChange={handlePovTypeChange}>
                    ...
                    {tempPovType !== "Third Person Omniscient" && (
                        <div className="grid gap-2">
                            ...
                            <Select value={tempPovCharacter} onValueChange={setTempPovCharacter}>

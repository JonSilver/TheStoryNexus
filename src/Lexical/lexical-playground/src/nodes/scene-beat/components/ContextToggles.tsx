                ...
                <CollapsibleContent>
                    <div className="space-y-4 mb-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={useMatchedChapter} onCheckedChange={onMatchedChapterChange} />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={useMatchedSceneBeat} onCheckedChange={onMatchedSceneBeatChange} />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={useCustomContext} onCheckedChange={onCustomContextChange} />
                        </div>
                    </div>
